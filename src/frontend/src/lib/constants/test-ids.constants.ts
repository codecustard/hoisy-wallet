...
export const RECEIVE_TOKENS_MODAL_BTC_MAINNET_SECTION = 'receive-tokens-modal-btc-mainnet-section';
...
export const RECEIVE_TOKENS_MODAL_KASPA_MAINNET_SECTION =
	'receive-tokens-modal-kaspa-mainnet-section';
export const RECEIVE_TOKENS_MODAL_KASPA_TESTNET_SECTION =
	'receive-tokens-modal-kaspa-testnet-section';
...
export const TOKEN_MENU_KASPA = 'token-menu-kaspa';
export const TOKEN_MENU_KASPA_BUTTON = 'token-menu-kaspa-button';
